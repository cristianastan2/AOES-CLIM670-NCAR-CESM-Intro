...
From your `/glade/work/username/cesm2.1.5` directory, see what is there.
~~~
$ ls
~~~
{: .language-bash}
...
Create a new case
~~~
$ ./create_newcase --case ~/cases/b.day1.0 --res f19_g17 --compset B1850 --project UGMU0049
~~~
{: .language-bash}
